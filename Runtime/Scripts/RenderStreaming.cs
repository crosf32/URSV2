...
#pragma warning restore 0649
        ...
        static ISignaling CreateSignaling(
            string type, string roomIdentifier, string url, float interval, SynchronizationContext context)
        {
            ...
            object[] args = { url, interval, context, roomIdentifier };
        ...
        public void StartConnection(string roomIdentifier)
        {
